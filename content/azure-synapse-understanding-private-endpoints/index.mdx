...
2. Utilizing an [Azure Synpase Link Hub](#private-link-hub), you're able to create a private endpoint into the customer's owned vNet.
...
Or can also be set during the Synpase workspace creation.
